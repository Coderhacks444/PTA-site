    ...
    <section className="bg-amber-100 min-h-screen mt-10">
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 px-6 py-12 fade-in-up">
        ...
        <div className="flex-1 max-w-xl text-gray-800">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 text-gray-800">💎 What Sets Us Apart</h2>
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 text-gray-800">🔬 Our Promise</h2>
        ...
        <div className="flex-1 flex flex-col items-center justify-center max-w-lg w-full">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Certificate of PTA</h2>
