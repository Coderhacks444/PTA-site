...
function KitSlider({ images, cardBg }) {
  ...
  return (
    <div className={`w-full ${cardBg} rounded-lg shadow p-3 h-[500px] sm:h-[450px] md:h-[420px] mx-auto`}>
...
export default function Kits() {
  return (
    <section className="bg-orange-200 min-h-[80vh] w-full py-12 mt-10">
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-stretch justify-center px-4 md:px-8 max-w-7xl mx-auto">
        {/* Kits Slider */}
        <div className="flex-1 flex flex-col">
          <h2 className="text-xl font-semibold mb-4 text-amber-600 text-center">Kits</h2>
          <KitSlider images={kitImages} cardBg="bg-orange-300" />
        </div>
        {/* Instruments Slider */}
        <div className="flex-1 flex flex-col">
          <h2 className="text-xl font-semibold mb-4 text-green-700 text-center">Instruments</h2>
